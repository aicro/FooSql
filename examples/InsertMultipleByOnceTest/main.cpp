...
int main()
{
	...
	try
    {
        ...
        DbExecuteAction* insert_action = mysqlTasks->Insert(5000);

        stringstream ss;
        ss << "INSERT INTO tbl_test(id, name, uptime) VALUES";

        int row_count = 0;
        while (row_count++ < 10)
        {
            ss << "(" << row_count * 100 << "," << "'tset1'," << "'20130101'),";
        }
        ...
        InsertFilter insertFilter(statement);
